...
import com.gowtham.letschat.databinding.LoadStateFooterBinding

class LoadStateAdapter(private val retry: () -> Unit) :
    LoadStateAdapter<com.gowtham.letschat.fragments.search.LoadStateAdapter.LoadStateViewHolder>() {
