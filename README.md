...
*Following firebase services need to be enabled
  -Phone Auth
  -Cloud Firestore
  -Realtime Database
  -Storage
  -Composite indexes has to be added for contact query(link for enabling indexes could be found from logcat while using the app)
